...
$VersionFiles = @(
    @{
        Path        = "Unity-Package/Packages/com.ivanmurzak.unity.mcp.animation/package.json"
        Pattern     = '"version":\s*"[\d\.]+"'
...
function Get-CurrentVersion {
    ...
    $packageJsonPath = "Unity-Package/Packages/com.ivanmurzak.unity.mcp.animation/package.json"
