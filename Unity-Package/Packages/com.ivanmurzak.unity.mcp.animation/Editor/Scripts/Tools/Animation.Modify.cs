...
namespace com.IvanMurzak.Unity.MCP.Animation
{
    public static partial class AnimationTools
    {
        ...
        [AiSkillDescription("Apply a batch of modifications to a Unity `AnimationClip` — set/remove float " +
        ...
        [AiSkillBody("Apply a batch of modifications to a Unity `AnimationClip` asset. Each modification " +
        ...
        )
        {
            ...
            return MainThread.Instance.Run(() =>
            {
                ...
                {
                    path = assetPath,
                    instanceId = animation.GetEntityId(),
                    name = animation.name
                };
