...
namespace com.IvanMurzak.Unity.MCP.Animation
{
    public static partial class AnimatorTools
    {
        ...
        [AiSkillDescription("Apply a batch of modifications to a Unity `AnimatorController` — add/remove " +
        ...
        [AiSkillBody("Apply a batch of modifications to a Unity `AnimatorController` asset. Each " +
